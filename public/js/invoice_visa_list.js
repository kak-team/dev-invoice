    ...
    $(parent_private).on('click','.new-row',function(){
        ...
        if(status_vat == 'no_vat'){
            ...
            var html = '<tr>';
                ...
                html += '<td> <div class="md-form m-0"> <input type="text" id="nationality_'+loop+'" name="nationality[]" placeholder="Nationality" required="" class="form-control m-0" autocomplete="off"> </div></td>';
