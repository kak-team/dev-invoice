    ...
    $(parent_private).on('click','.new-row',function(){
        ...
        if(status_vat == 'no_vat'){
            ...
            var html = '<tr>';
                ...
                html += '<td class="text-center"> <div class="md-form m-0"> <input type="text" id="total_adult_'+loop+'" name="total_adult[]" class="total_adult_'+loop+' form-control m-0" required placeholder="Total Adult" autocomplete="off"></span> </div> </td>';
                html += '<td class="text-center"> <div class="md-form m-0"> <input type="text" id="total_child_'+loop+'" name="total_child[]" class="total_child_'+loop+' form-control m-0" required placeholder="Total Child" autocomplete="off"></span> </div> </td>';
        ...
        $(parent_private+' .table-create1').append(html);
