...
<div class="row">
    ...
    <div class="card">
        <div class="card-header header-elements-sm-inline py-2">
            <h6 class="card-title font-weight-bold"> <i class="icon-users4 pr-2"></i> PAYMENT METHOD LISTS</h6>
            <div>
        ...
        <div class="table-responsive">
                <table class="table text-nowrap">
                    ...
                    <tr>
                        ...
                        <td class="text-blue-800 font-weight-bold">PAYMENT METHOD NAME</td>
                    ...
                    @foreach($values as $value)
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-outline bg-info-400 border-info-400 text-info-800 btn-icon rounded-round legitRipple mr-1" data-toggle="modal" data-target="#modal_theme_info" id="btn-edit" value="{{ $value->id }}" paymentmethod_id="{{ $value->id }}" paymentmethod_name="{{ $value->name }}" paymentmethod_description="{{ $value->description }}"><i class="icon-quill4"></i></button></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
...
<script>
    $('document').ready(function(){
        ...
        var html = '<tr>';
            html += '<td><div class="col form-group form-group-feedback form-group-feedback-left"><input type="text" class="form-control" placeholder="Payment method name" name="paymentmethod_name[]" id="paymentmethod_name" autocomplete="off"><div class="form-control-feedback"><i class="icon-magazine text-muted"></i></div></div></td>';
            html += '<td><div class="col form-group form-group-feedback form-group-feedback-left"><input type="text" class="form-control" placeholder="Payment method description" name="paymentmethod_description[]" id="paymentmethod_description" autocomplete="off"><div class="form-control-feedback"><i class="icon-user text-muted"></i></div></div></td>';
        ...
        $('#modal_theme_success').on('click','#add-more',function(){
            $('#modal_theme_success #paymentmethod').append(html);
        });
