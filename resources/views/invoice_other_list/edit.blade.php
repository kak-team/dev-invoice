        ...
        <div class="card mb-0">
                <div class="card-body">
                    ...
                    <table class="table border table-create table-bordered">
                        ...
                        @foreach($invoice->other_list as $other_list)
                            <tr>
                                <td class="position-relative text-center hidMode">                                    
                                    <input type="hidden" name="other_list_id[]" value="{{$other_list->id}}">
                                </td>                                
                                <td class="position-relative text-center" id="hidMode_{{ $loop->iteration }}E">
                                    <div class="Dtdisabled"></div>
                                    <input type="hidden" name="e_n_p[]" id="np_{{ $loop->iteration }}E" value="{{ $other_list->net_price }}">
                                    <span></span>
                                </td>
                                <td class="text-center">                                
                                    <div class="md-form m-0">
                                        <input type="text" value="{{ $other_list->full_name }}" id="e_fullname{{ $loop->iteration }}" name="e_full_name[]" class="fullname{{ $loop->iteration }} form-control m-0" required placeholder="Full Name" autocomplete="off"></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="md-form m-0">
                                        <input type="text" value="{{ $other_list->service_for }}" id="e_service_for{{ $loop->iteration }}" name="e_service_for[]" placeholder="Service For" required class="form-control m-0" autocomplete="off">                                    
                                    </div>                
                                </td>
                                ...
                                <td class="position-relative">
                                    ...
                                    <div class="md-form m-0">
                                        <input type="number" name="e_qty[]" id="qty_{{ $loop->iteration }}E" class="form-control m-0 text-center qty" readonly value="{{ $other_list->quantity }}">                                    
                                    </div>
                                </td>
                                <td>
                                    <div class="md-form m-0">
                                        <input type="number" name="e_price[]" id="price_{{ $loop->iteration }}E" step="0.01" class="form-control m-0 text-center price" value="{{ $other_list->price }}">                                    
                                    </div>
                                </td>
                    ...
                    <table class="table border table-create table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">                                
                                <div class="md-form m-0">
                                    <input type="text"  value="{{ $other_list->full_name }}" id="fullname{{ $loop->iteration }}" name="e_full_name[]" class="fullname{{ $loop->iteration }} form-control m-0" required placeholder="Full Name" autocomplete="off"></span>
                                </div>
                            </td>
                            <td>
                                <div class="md-form m-0">
                                    <input type="text" value="{{ $other_list->service_for }}" id="service_for{{ $loop->iteration }}" name="e_service_for[]" placeholder="Passport Number" required class="form-control m-0" autocomplete="off">                                    
                                </div>                
                            </td>
                            ...
                            <td class="position-relative">
                                <div class="Tddisabled"></div>
                                <div class="md-form m-0">
                                    <input type="number" value="{{ $other_list->quantity }}" name="e_qty[]" id="qty{{ $loop->iteration }}" class="form-control m-0 text-center qty" readonly >                                    
                                </div>
                            </td>
                            <td>
                                <div class="md-form m-0">
                                    <input type="number" value="{{ $other_list->net_price }}" name="e_n_p[]" class="form-control m-0 text-center qty" id="np{{ $loop->iteration }}">
                                </div>
                            </td>
                            <td>
                                <div class="md-form m-0">
                                    <input type="number" value="{{ $other_list->price }}" name="e_price[]" id="price{{ $loop->iteration }}" step="0.01" class="form-control m-0 text-center price" value=0>                                    
                                </div>
                            </td>
                        ...
                        <div class="col-lg-5 mt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 pr-1">
                                    ...
                                    <div class=" form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">                                        
                                        <input type="number" value="{{ $invoices[0]->service_fee_price*$invoice->other_list->count('id') }}" step="0.01" readonly class="bgwhiteblue form-control font-weight-bold totalInput border-color" name="servicefee_total" id="SerFee_total" value="0.00" required="" autocomplete="off">    
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class=" md-bg form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">
                                        <input type="number" value="{{ ($invoices[0]->service_fee_price*$invoice->other_list->count('id'))/$invoice->vat_percent }}" step="0.01" readonly class="bgwhiteblue form-control font-weight-bold totalInput border-color" name="vat_total" id="vat_total" value="0.00" required="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            @endif
