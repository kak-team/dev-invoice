...
<form method="post" action="{{ action('InvoiceController@exe_form_edit_invoice') }}">
    ...
    <input type="hidden" value="invoice_insurance_list" name="route">
    <input type="hidden" value="3" name="service_id">
        ...
        <div class="card mb-0">
                <div class="card-body">
                    ...
                    <table class="table border table-create table-bordered">
                        ...
                        @foreach($invoice->insurance_list as $insurance)
                            <tr>
                                <td class="position-relative text-center hidMode">                                    
                                    <input type="hidden" name="insurance_list_id[]" value="{{ $insurance->id}}">
                                </td>                                
                                <td class="position-relative text-center" id="hidMode_{{ $loop->iteration }}E">
                                    <div class="Dtdisabled"></div>
                                    <input type="hidden" name="e_n_p[]" id="np_{{ $loop->iteration }}E" value="{{ $insurance->net_price }}">
                                    <span></span>
                                </td>
                                <td class="text-center">                                
                                    <div class="md-form m-0">
                                        <input type="text" value="{{ $insurance->full_name }}" id="e_fullname_1" name="e_full_name[]" class="fullname_1 form-control m-0" required placeholder="Full Name" autocomplete="off"></span>
                                    </div>
                                </td>
                                ...
                                <td class="position-relative">
                                    ...
                                    <div class="md-form m-0">
                                        <input type="number" name="e_qty[]" id="qty_{{ $loop->iteration }}E" class="form-control m-0 text-center qty" readonly value="{{ $insurance->quantity }}">                                    
                                    </div>
                                </td>
                                <td>
                                    <div class="md-form m-0">
                                        <input type="number" name="e_price[]" id="price_{{ $loop->iteration }}E" step="0.01" class="form-control m-0 text-center price" value="{{ $insurance->price }}">                                    
                                    </div>
                                </td>
                    ...
                    <table class="table border table-create table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">                                
                                <div class="md-form m-0">
                                    <input type="text"  id="fullname_1" value="{{ $insurance->full_name }}" name="e_full_name[]" class="fullname_1 form-control m-0" required placeholder="Full Name" autocomplete="off"></span>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="md-form m-0">
                                    <input type="number" name="n_p[]" class="form-control m-0 text-center qty" id="np_1" value="{{ $insurance->net_price }}">
                                </div>
                            </td>
                            <td>
                                <div class="md-form m-0">
                                    <input type="number" name="price[]" id="price_1" step="0.01" class="form-control m-0 text-center price" value="{{ $insurance->price }}">                                    
                                </div>
                            </td>
                            ...
                            <div class="row">
                                <div class="col-lg-6 pl-0">
                                    ...
                                    <div class=" form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">
                                        <input type="date" class="form-control font-weight-bold totalInput border-color" id="routing" name="from_date" required="" value="{{ date('Y-m-d',strtotime($invoice->insurance->from_date)) }}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class=" form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">
                                        <input type="date" class="form-control font-weight-bold totalInput border-color" id="routing" name="to_date" required="" value="{{ date('Y-m-d',strtotime($invoice->insurance->to_date)) }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5 mt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 pr-1">
                                    ...
                                    <div class=" form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">                                        
                                        <input type="number" value="{{ $invoices[0]->service_fee_price*$invoice->insurance_list->count('id') }}" step="0.01" readonly class="bgwhiteblue form-control font-weight-bold totalInput border-color" name="servicefee_total" id="SerFee_total" value="0.00" required="" autocomplete="off">    
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class=" md-bg form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">
                                        <input type="number" value="{{ ($invoices[0]->service_fee_price*$invoice->insurance_list->count('id'))/$invoice->vat_percent }}" step="0.01" readonly class="bgwhiteblue form-control font-weight-bold totalInput border-color" name="vat_total" id="vat_total" value="0.00" required="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            @endif
