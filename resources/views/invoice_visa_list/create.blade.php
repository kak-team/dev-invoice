                ...
                @if($vat == 'vat')
                    ...
                    <table class="table border table-create table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="md-form m-0">
                                    <input type="text" id="nationality_1" name="nationality[]" placeholder="Nationality" required class="form-control m-0" autocomplete="off">                                    
                                </div>                
                            </td>
                            <td>
                                <div class="md-form m-0">
                        ...
                        <div class="col-lg-5 mt-3">
                            ...
                            <div class="row">
                                <div class="col-lg-6 pl-0">
                                    ...
                                    <div class=" form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">
                                        <input type="date" class="form-control font-weight-bold totalInput border-color" id="routing" name="application_date" required="" value="{{ date('Y-m-d') }}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class=" form-group form-group-feedback form-group-feedback-left mb-0 border font-weight-bold">
                                        <input type="date" class="form-control font-weight-bold totalInput border-color" id="routing" name="pick_date" required="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
