                ...
                <tr role="row" class="odd">
                    ...
                    @endphp
                        @if($total_payment == $value->total_amount)
                            <button class="btn bg-success legitRipple btn-sm badge" data-invoice-number="{{ $value->invoice_number }}" data-toggle="modal" data-target="#Modal_payment" id="btn-payment" value="{{ $value->id }}" data-amount= "{{ $value->total_amount }}">
                                PAID
                            </button>
                        @else
                            <button class="btn bg-orange legitRipple btn-sm badge" data-invoice-number="{{ $value->invoice_number }}" data-toggle="modal" data-target="#Modal_payment" id="btn-payment" value="{{ $value->id }}" data-amount= "{{ $value->total_amount }}">
                                UNPAID
                            </button>
                        @endif
